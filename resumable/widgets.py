...
from django.forms.widgets import FileInput, Widget
...
class ResumableFileDropInput(Widget):
    template_name = 'resumable/file_drop_input.html'

    def __init__(self, *args, **kwargs):
        super(ResumableFileDropInput, self).__init__(*args, **kwargs)
        self.filepath = None
        self.filename = None
